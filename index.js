...
let isLoop = false;
let channelIDs = [
  880142443666890772, 880142490076868681, 880142509089624164,
  880142844684300379, 880151088790142976, 880141903448903780,
  900371757234520174, 894223161065885716,
];
...
bot.on("message", async (message) => {
  ...
  switch (command.toLowerCase()) {
    ...
    case "nonna_macu": {
      message.channel.send(
        "<@" + message.author.id + ">, ECCOTI LA NONNA DI MACUGLIA",
        {
          files: [
            {
    ...
    case "feng": {
      message.channel.send(
        "<@" + message.author.id + ">, TI PRESENTO QUEL NABBO DI FENG",
        {
          files: [
            {
    ...
    case "jackie": {
      message.channel.send(
        "<@" + message.author.id + ">, ECCOTI IL PAPÀ DI JACKIE",
        {
          files: [
            {
    ...
    case "willi": {
      message.channel
        .send("<@" + message.author.id + ">, BECCATI UN **WILLI**", {
          files: [
            {
    ...
    case "mark's_pizzeria": {
      message.channel.send(
        "<@" + message.author.id + ">, ECCOTI LA MIGLIORE PIZZERIA ",
        {
          files: [
            {
    ...
    case "già": {
      await callSong(
        ...
        command,
        message,
        "gia-lo-sai-last-friday-night-rmx.mp3",
        true
      );
      break;
    }
